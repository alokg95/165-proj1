...
accuracy_a = float(a_stats[0]+a_stats[1])/float(float(line_one[1])+float(line_one[2])+float(line_one[3]))
accuracy_b = float(b_stats[0]+b_stats[1])/float(float(line_one[1])+float(line_one[2])+float(line_one[3]))
accuracy_c = float(c_stats[0]+c_stats[1])/float(float(line_one[1])+float(line_one[2])+float(line_one[3]))
...
accuracy_avg = (accuracy_a+accuracy_b+accuracy_c)/3
precision_avg = (precision_a+precision_b+precision_c)/3

print "True positive rate =", TPR_avg
print "False positive rate =", FPR_avg
print "Error Rate =", error_avg
